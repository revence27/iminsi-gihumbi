...
var condenseNavBar, deleteableColumns, drFridaysDrillDown, jigTheElements, makeDrillable, participatingTable;
...
drFridaysDrillDown = function(dest) {
  var pl, play, _i, _len, _ref, _results;
  _ref = $('.descr');
  _results = [];
  for (_i = 0, _len = _ref.length; _i < _len; _i++) {
    pl = _ref[_i];
    play = $(pl);
    _results.push(makeDrillable(pl, "subcat=" + (play.attr('keyword'))));
  }
  return _results;
};

makeDrillable = function(dr, apdg) {
  var drill;
  drill = $(dr);
  return drill.click(function() {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      nwtbl.append(dstr);
      makeDrillable(nmtd);
      _results.push($.ajax("" + finu + "&summary=on", {
        context: dstd,
