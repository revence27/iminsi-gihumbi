...
(function () {
    ...
    var t, y = document,
        ...
        Ob = /^[0-9]+$/,
        Pb = "stroke-width",
        eb, Ra, pb, qb, rb, Xa, fb, gb, Db, Eb, sb, Fb, Gb, F = {},
    ...
    if (!aa && !fa) {
        R.VMLElement = X = {
            ...
            fillSetter: function (a, b, c) {
                ...
                else if (d !== "IMG") c.filled = a !== Q, this.setAttr("fillcolor", this.renderer.color(a, c, b, this))
            },
            opacitySetter: sa,
        ...
        var ga = {
            ...
            color: function (a, b, c, d) {
                ...
                if (i) {
                    ...
                    if (c === "fill")
                        if (i === "gradient") c = o.x1 || o[0] || 0, a = o.y1 || o[1] || 0, n = o.x2 || o[2] || 0, o = o.y2 || o[3] || 0, x = 'angle="' + (90 - U.atan((o - a) / (n - c)) * 180 / ma) + '"', q();
                        else {
                            var j = o.r,
                                t = j * 2,
                                u = j * 2,
                ...
                } else if (g.test(a) && b.tagName !== "IMG") f = ya(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], Y(this.prepVML(h), null, null, b), j = f.get("rgb");
                else {
    ...
    Sa.prototype = {
        ...
        render: function (a, b, c) {
            ...
            if (i && !isNaN(y)) i.xy = w = this.getLabelPosition(y, w, i, g, k, u, a, v), this.isFirst && !this.isLast &&
    ...
    la.prototype = {
        ...
        setMaxTicks: function () {
            ...
            if (!this.isLinked &&
                !this.isDatetimeAxis && c && c.length > (b[d] || 0) && this.options.alignTicks !== !1) b[d] = c.length;
            a.maxTicks = b
        },
        ...
        getOffset: function () {
            ...
            if (j || a.isLinked) {
                ...
                for (q in f) f[q].destroy(), delete f[q]; if (n && n.text && n.enabled !== !1) {
        ...
        render: function () {
            ...
            if (q || h)
                if (a.minorTickInterval && !a.categories && p(a.getMinorTickPositions(), function (b) {
                    ...
                    if (!h || b >= a.min && b <= a.max) l[b] || (l[b] = new Sa(a, b)), x && l[b].isNew && l[b].render(c, !0, 0.1), l[b].render(c, !1, 1)
            ...
            if (L) b = a.getLinePath(L), a.axisLine ? a.axisLine.animate({
                d: b
    ...
    O.prototype = {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData) p(a, function (a, b) {
                ...
                if (s && h > s) {
                    ...
                    if (ha(k)) {
                        ...
                        if (v)
                            for (c = 0; c < h; c++) i = a[c], q[c] = i[0], r[c] = i.slice(1, v + 1);
                        else
                            for (c = 0; c < h; c++) i = a[c], q[c] = i[0], r[c] = i[1];
                    else ra(12)
                } else
                    for (c = 0; c < h; c++)
                        if (a[c] !== t && (i = {
        ...
        processData: function (a) {
            ...
            if (l && this.sorted && (!j || d > j || this.forceCrop))
                ...
                else if (b[0] < o || b[d - 1] > n) e = this.cropData(this.xData, this.yData, o, n), b = e.xData, c = e.yData,
        ...
        generatePoints: function () {
            ...
            if (b && (g !== (c = b.length) || j))
                for (o = 0; o < c; o++)
                    if (o === h && !j && (o += g), b[o]) b[o].destroyElements(), b[o].plotX =
                        t;
            this.data = b;
            this.points = l
        },
            ...
            if (d.enabled !== !1 || this._hasPointMarkers)
                for (f =
                    ...
                    if (g = b[f], d = T(g.plotX), e = g.plotY, k = g.graphic, i = g.marker || {}, a = s && i.enabled === t || i.enabled, o = c.isInsidePlot(u(d), e, c.inverted), a && e !== t && !isNaN(e) && g.y !== null)
                        if (a = g.pointAttr[g.selected ? "select" : ""] || l, h = a.r, i = m(i.symbol, this.symbol), j = i.indexOf("url") === 0, k) k[o ? "show" : "hide"](!0).animate(q({
                            x: d - h,
                            y: e - h
                        }, k.symbolName ? {
                            width: 2 * h,
    ...
    var pa = ka(O, {
        ...
        getSegmentPath: function (a) {
            ...
            if (e.stacking && !this.closedStacks)
                for (d = a.length - 1; d >= 0; d--) g = m(a[d].yBottom, f), d < a.length - 1 && e.step && c.push(a[d + 1].plotX, g), c.push(a[d].plotX, g);
    ...
    ga = ka(O, {
        ...
        drawPoints: function () {
            ...
            p(a.points, function (i) {
                var j = i.plotY,
                    k = i.graphic;
                if (j !== t && !isNaN(j) && i.y !== null) f = i.shapeArgs, h = r(a.borderWidth) ? {
    ...
    if (F.pie) F.pie.prototype.drawDataLabels = function () {
        ...
        if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                if (l > 0) {
                    ...
                    for (B = 0; B < I; B++) {
                        ...
                        if (E < B && b[B] !== null) E = B;
                            ...
                            for (w < I - B + E && b[B] !== null && (E = w - I + B); b[E] === null;) E++;
                        K.push({
                            i: E,
                            y: b[E]
                        });
            ...
            if (Ba(F) === 0 || this.verifyDataLabelOverflow(F)) this.placeDataLabels(), r && g && p(this.points, function (b) {
                i = b.connector;
                x = b.labelPos;
                if ((t = b.dataLabel) && t._pos) G = t._attr.visibility, A = t.connX, C = t.connY, j = k ? ["M", A + (x[6] === "left" ? 5 : -5), C, "C", A, C, 2 * x[2] - x[4], 2 * x[3] - x[5], x[2], x[3], "L", x[4], x[5]] : ["M", A + (x[6] === "left" ? 5 : -5), C, "L", x[2], x[3], "L", x[4], x[5]], i ? (i.animate({
                    d: j
